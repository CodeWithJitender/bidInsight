...
export default function PersonalDetail({ profileData, onProfileUpdate }) {
  ...
  // ✅ NEW: Store original data for cancel functionality
        ...
        <div className="flex gap-2">
          {!isEditing ? (
            ...
            <button
              ...
              className="text-sm px-4 py-2 rounded-full bg-primary font-inter text-white hover:bg-blue-700 transition"
            >
              <i className="fal fa-pen-alt"></i> Edit
            </button>
          ) : (
            // Save & Cancel Buttons
            <>
              <button
                ...
                className="text-sm px-4 py-2 rounded-full bg-gray-400 font-inter text-white hover:bg-gray-500 transition"
              >
                 Cancel
              </button>
              <button

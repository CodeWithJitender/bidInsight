        ...
        <div className="overflow-auto relative">
          <table className="min-w-full  border-spacing-y-6 text-sm sm:text-base relative border-collapse  ">
            ...
            <tbody>
              {sections
                .filter((sec) => {
                  if (subscriptionPlanId === "001") {
                    return sec.title !== "Full Stack A.I. Arsenal";
                  }
                  return true; // show all sections for 002 or 003
                })
                .map((section, sIdx) => (
                  <React.Fragment key={sIdx} className="">
                    ...
                    {section.features.map((feature, fIdx) => (
                      <tr key={fIdx} className="border-b  border-primary">
